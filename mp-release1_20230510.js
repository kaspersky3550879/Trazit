export const MpRelease1 = {
  "TrackingChanges": {
    "version": 0.9,
    "last change on (YYYYMMDD)": "20230308",
  ...
  "LogSamples": {
    ...
    "langConfig": {
      ...
      "gridHeader": {
        ...
        "requires_tracking_sampling_end": {
          "label_en": "Sampling Static?",
          "label_es": "Muestreo Estático?",
          "sort": false,
          "filter": true,
          "width": "40%"
        }
  ...
  "SamplePlateReadingSecondEntry": {
    ...
    "langConfig": {
      "title": {
        "PlateReadingSecondEntrySMP": {
          "label_en": "Samples Pending Plate Reading Second Entry",
          "label_es": "Muestras pendientes de confirmación de lectura de placa"
        },
        "PlateReadingSecondEntryPERS": {
          "label_en": "Personnel Samples Pending Plate Reading Confirmation",
          "label_es": "Muestras de personal pendientes confirmación de la lectura de placa"
        }
      },
      "gridHeader": {
        "sample_id": {
    ...
    "viewQuery": {
      ...
      "endPointParams": [
        ...
        {
          "argumentName": "whereFieldsValue",
          "value": "PlateReadingSecondEntry|prog_pers_template"
        }
      ],
      "subViewFilter": {
        "PlateReadingSecondEntrySMP": [
    ...
    "actions": [
      ...
      },
      {
        ...
        "endPointParams": [
          ...
          {
            "argumentName": "sampleAnalysisResultWhereFieldsName",
            "value": "entered_by"
          },
          {
            "argumentName": "sampleAnalysisResultWhereFieldsValue",
            "value": "TOKN_internalUserID*String"
          }
        ]
      }
    ]
    ...
    "viewQuery": {
      ...
      "subViewFilter": {
        "MicroOrganismSMP": [
          {
            "argumentName": "whereFieldsName",
            "value": "current_stage|sample_config_code"
          },
          {
            "argumentName": "whereFieldsValue",
            "value": "MicroorganismIdentification|program_smp_template"
          }
        ],
        "MicroOrganismPERS": [
          {
      ...
      "actions": [
        ...
        },
        {
          ...
          "button": {
            ...
            "color": "Orange",
            "title": {
              "label_en": "Incubation1, Not in Batch",
              "label_es": "Incubación1, Pendiente Asignar Tanda"
            },
            "requiresGridItemSelected": true
          }
        },
        {
          ...
          "button": {
            ...
            "color": "Tomato",
            "title": {
              "label_en": "Incubation1, In Batch",
              "label_es": "Incubación1, En Tanda"
            },
            "requiresGridItemSelected": true
          }
        },
        {
          ...
          "button": {
            ...
            "title": {
              "label_en": "Incubation1 In-Progress",
              "label_es": "Incubación1 en curso"
            },
            "requiresGridItemSelected": true
          }
        },
        {
          ...
          "button": {
            ...
            "title": {
              "label_en": "Incubation2, Not in Batch",
              "label_es": "Incubación2, Pendiente Asignar Tanda"
            },
            "requiresGridItemSelected": true
          }
        },
        {
          ...
          "button": {
            ...
            "color": "SlateBlue",
            "title": {
              "label_en": "Incubation2, In Batch",
              "label_es": "Incubación2, En Tanda"
            },
            "requiresGridItemSelected": true
          }
        },
        {
          ...
          "button": {
            "img": "incubators/IncubInProgress.gif",
            "title": {
              "label_en": "Incubation2 In-Progress",
              "label_es": "Incubación2 en curso"
            },
            "requiresGridItemSelected": true
          }
        },
    ...
    "actions": [
      {
        ...
        "dialogInfo": {
          ...
          "fields": [
            {
              "text1": {
                "label_en": "New Incub Name",
                "label_es": "Nombre para nueva Incubadora"
              }
            },
            {
              "list1": {
                "items": [
                  {
                    "keyName": "1",
                    "keyValue_en": "1st Incub",
                    "keyValue_es": "1ª Incub"
                  },
                  {
                    "keyName": "2",
                    "keyValue_en": "2nd Incub",
                    "keyValue_es": "2ª Incub"
                  }
                ],
        ...
        "endPointParams": [
          ...
          {
            "argumentName": "minTemp",
            "element": "number1"
          },
          {
            "argumentName": "maxTemp",
            "element": "number2"
          }
        ]
      },
      {
        ...
        "dialogInfo": {
          ...
          "fieldsObject": {
            ...
            "objectName": {
              "label_en": "Incubator Name to reactivate",
              "label_es": "Nombre de Incubadora a Reactivar"
            }
          },
          "listDefinition": {
            "keyFldName": "name",
      ...
      },
      {
        ...
        "button": {
          "icon": "add",
          "title": {
            "label_en": "Add Temperature Reading",
            "label_es": "Añadir Registro Temperatura"
          },
          "requiresGridItemSelected": true
        },
        "dialogInfo": {
