...
import '@mpachnis/mp-calendar/mp-calendar-theme';

'use-strict';

class mpCalendarExt extends GestureEventListeners(PolymerElement) {
    static get template() {
        return html`
...
customElements.define(mpCalendarExt.is, mpCalendarExt);
